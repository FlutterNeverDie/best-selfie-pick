  ...
  final List<Map<String, dynamic>> notices = const [
    {
      ...
      'content': '''
💡 지역별 독립 콘테스트
사용자는 현재 마이페이지에 설정된 지역의 콘테스트에만 참가 및 투표가 가능합니다.
...
'''
    },
    {
      ...
      'content': '''
👤 참가 자격
누구나 참가 가능하며, 여러 지역에 참가할 수 있습니다. 참가 신청 시, 사진은 즉시 '승인 대기중' 상태가 됩니다.
...
'''
    },
    {
      ...
      'content': '''
🗳️ 투표 제한
사용자는 해당 주차에 지역당 1회 투표만 가능합니다. (지역을 변경하면 다른 지역에도 투표 가능)
...
'''
    ...
    {
      'icon': Icons.map_outlined, // 지역/데이터 아이콘
      'title': '지역 변경 및 데이터 처리',
      'content': '''
🔄 지역 변경
지역 설정은 마이페이지에서만 변경 가능합니다. 지역을 변경하면 챔피언, 랭킹, 참가 탭의 모든 조회 기준이 즉시 변경됩니다.
